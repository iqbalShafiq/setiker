...
import setiker.composeapp.generated.resources.permission_education_title

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PermissionEducationBottomSheet(
    visible: Boolean,
    onDismiss: () -> Unit,
    onAllow: () -> Unit
) {
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Text(
                text = stringResource(Res.string.permission_education_title),
            ...
            Text(
                text = stringResource(Res.string.permission_education_message),
                style = MaterialTheme.typography.bodyMedium,
                color = neubrutalSubtleOnSurface()
            )
            Spacer(modifier = Modifier.height(20.dp))
            AppPrimaryButton(
                text = stringResource(Res.string.permission_education_allow),
                onClick = {
                    onDismiss()
                    onAllow()
                },
            ...
            AppSecondaryButton(
                text = stringResource(Res.string.permission_education_not_now),
                onClick = onDismiss,
                modifier = Modifier.fillMaxWidth()
            )
        }
